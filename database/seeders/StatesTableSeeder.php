...
class StatesTableSeeder extends Seeder
{
    ...
    {
        $rows = [
            ['state_id' => 1, 'state_name' => 'Abuja'],
            ['state_id' => 2, 'state_name' => 'Abia'],
            ['state_id' => 3, 'state_name' => 'Anambra'],
            ['state_id' => 4, 'state_name' => 'Akwa Ibom'],
            ['state_id' => 5, 'state_name' => 'Adamawa'],
            ['state_id' => 6, 'state_name' => 'Bauchi'],
            ['state_id' => 7, 'state_name' => 'Bayelsa'],
            ['state_id' => 8, 'state_name' => 'Benue'],
            ['state_id' => 9, 'state_name' => 'Borno'],
            ['state_id' => 10, 'state_name' => 'Cross River'],
            ['state_id' => 12, 'state_name' => 'Ebonyi'],
            ['state_id' => 13, 'state_name' => 'Edo'],
            ['state_id' => 14, 'state_name' => 'Ekiti'],
            ['state_id' => 15, 'state_name' => 'Enugu'],
